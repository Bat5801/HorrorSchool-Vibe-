class Chapter3 {
    ...
    seeWhoIsThere() {
        ...
        this.showDialogue(`你转身，看到${friendName}站在你身后，脸色苍白。${this.game.gameState.playerGender === "male" ? "他" : "她"}的眼睛里没有瞳孔，取而代之的是闪烁的红光。
...
${this.game.gameState.playerGender === "male" ? "他" : "她"}的身体开始扭曲，皮肤下似乎有什么东西在蠕动。`, [
    ...
    backAwayFromFriend() {
        const friendName = this.game.gameState.playerGender === "male" ? "张伟" : "李娜";
        this.showDialogue(`你后退几步，${friendName}步步紧逼。${this.game.gameState.playerGender === "male" ? "他" : "她"}的指甲变得又长又尖，眼睛里的红光越来越亮。`, [
