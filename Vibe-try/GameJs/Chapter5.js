class Chapter5 {
    ...
    showResultScreen() {
        ...
        // 显示章节名称和通关时间
        this.game.elements.resultChapter.textContent = '第五章 - 「黑暗源头」';
        ...
        endingDescription.innerHTML = `
            <p>恭喜你完成了游戏！</p>
            <p>你成功击败了黑暗源头，拯救了世界！</p>
            <p>光明再次降临，但黑暗从未真正消失...</p>
            <p>也许在另一个时间线，故事会有不同的结局...</p>
        `;
        ...
        // 显示二周目按钮
        if (this.game.elements.newGamePlusBtn) {
            this.game.elements.newGamePlusBtn.classList.remove('hidden');
            this.game.elements.newGamePlusBtn.textContent = '二周目 (未解锁)';
            this.game.elements.newGamePlusBtn.disabled = true;
        }
